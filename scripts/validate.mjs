...
if (!html.includes('function kmlMaxiReference(') || !html.includes('kmlMaxiReferenceCache.has(cacheKey)') || !html.includes('function kmlFolderReference(') || !html.includes('kmlSegmentNearLineRatio(segment, line, threshold, interval, samples)') || !html.includes('kmlMaxiSpatialEntries()') || !html.includes('function kmlNearbyMaxiEntries(') || !html.includes('function kmlBoundsCenterDistanceScore(') || !html.includes('.slice(0, 24)') || !html.includes('kmlBoundsCanOverlap(segmentBounds, entry.bounds, threshold)') || !html.includes('maxi_reference_category') || !html.includes('normalizeImportCategory(reference.importCategory)')) {
