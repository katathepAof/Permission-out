...
for (const id of ['projectTitle', 'saveProjectBtn', 'analyzeBtn', 'reportBody', 'map', 'peaLayerTrigger', 'peaLayerList', 'baseCatalogSearch', 'baseCatalogList', 'compareCatalogSearch', 'compareCatalogList']) {
